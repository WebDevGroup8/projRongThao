...
const promotionsL = [
    {
        image: "https://png.pngtree.com/template/20220330/ourmid/pngtree-new-shoes-promotion-in-simple-winter-2018-image_908218.jpg",
...
const promotionsP = [
    {
        image: "https://schollshoesthailand.com/cdn/shop/files/Sonic.png?v=1737033689&width=600",
        alt: "Buy More Save More",
    },
    {
        image: "https://schollshoesthailand.com/cdn/shop/files/4_2e499946-a346-45cf-a78c-9b1ea39554e4.webp?v=1736230585&width=600",
        alt: "New Arrivals - Shop Now",
    },
    {
        image: "https://schollshoesthailand.com/cdn/shop/files/6_3a303838-8938-4cdd-8dfa-a762974ca9c5.webp?v=1736230584&width=600",
        alt: "Free Shipping on Orders Over $50",
    },
]
        ...
        <div className="flex flex-col px-1 w-full pt-1 gap-4 lg:gap-10 lg:pt-10 ">
            ...
            <div className="flex flex-row w-full justify-center ">
                <div className="flex flex-row w-full items-center ">
                    ...
                    <h1 className="text-black text-ms lg:text-xl font-bold whitespace-nowrap px-3">BEST SELLER</h1>
                    <hr className="border-black border-1 w-full" />
                </div>
            </div>
