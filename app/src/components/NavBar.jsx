        ...
        <div className="w-full">
          <div className="relative w-full">
            <input
              type="search"
              id="default-search"
              className="block p-1 ps-3 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:ring-blue-500 focus:border-blue-500 w-full"
              placeholder="SEARCH"
              required
            />
            <button
              type="button"
              className="text-white absolute end-0.5 top-1/2 -translate-y-1/2 w-fit bg-blue-950 hover:bg-blue-800  focus:outline-none  font-medium rounded-full text-sm px-4 py-1.5 "
            >
              <svg
                className="w-3 h-3"
                aria-hidden="true"
