...
function Footer() {
  return (
    <div className="from-primary-dark mt-10 bg-gradient-to-r to-gray-900 px-6 py-8 text-gray-300 md:px-16 lg:px-28">
      <div className="grid w-full grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        <div>
          <h2 className="mb-4 text-xl font-semibold text-white">About Us</h2>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li className="flex items-center gap-3 transition-colors duration-300 hover:text-white">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a
              ...
              className="flex items-center gap-3 text-gray-400 transition-colors duration-300 hover:text-white"
            >
              <Github className="h-6 w-6 text-zinc-950" />
              <span>GitHub</span>
            </a>
          </div>
        </div>
